...
func (c *Client) SendMessage(message string) (response string, functionCalls []FunctionCall, error) {
...
func (c *Client) ExecuteFunctionCall(functionCall FunctionCall) (result interface{}, error) {
...
func (c *Client) executeSearchMarketplace(args map[string]interface{}) (interface{}, error) {
...
func (c *Client) executeGetTasteProfile(args map[string]interface{}) (interface{}, error) {
...
func (c *Client) executeGenerateAdCopy(args map[string]interface{}) (interface{}, error) {
    productTitle, ok := args["product_title"].(string)
    if !ok {
        return nil, fmt.Errorf("missing or invalid product_title parameter")
    }

    segmentsInterface, ok := args["segments"].([]interface{})
    if !ok {
